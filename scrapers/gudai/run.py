"""Gudai — gudai.inblaj.net. inblaj.net tenant; the parser lives in scrapers/common/inblaj_platform.py
...
if __name__ == "__main__":
    raise SystemExit(run_platform(slug="gudai", base="https://gudai.inblaj.net", source="Gudai", prefix="GUD"))

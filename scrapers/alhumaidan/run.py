"""Al Humaidan — al-humaidan.inblaj.net. inblaj.net tenant; the parser lives in scrapers/common/inblaj_platform.py
...
if __name__ == "__main__":
    raise SystemExit(run_platform(slug="alhumaidan", base="https://al-humaidan.inblaj.net", source="Al Humaidan", prefix="HUM"))

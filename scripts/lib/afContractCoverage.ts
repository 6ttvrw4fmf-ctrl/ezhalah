...
const S8: Entry[] = [
  ...
  { rule: 'R8.3.1', dim: 'af', weight: 2, grade: 'B', barrier: ['verify-af-footer-buttons'], evidence: 'footer is متابعة/تخطي/رجوع as real buttons; the early-exit stays removed (owner 2026-08-28) — pinned in both directions' },

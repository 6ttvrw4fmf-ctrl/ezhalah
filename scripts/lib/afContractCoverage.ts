...
const S7: Entry[] = [
  ...
  { rule: 'R7.1.2', dim: 'af', weight: 3, grade: 'L', barrier: ['verify-af-live-truth', 'verify-af-matrix-truth-live'], evidence: 'live browser: the card\'s footer IS the count RPC\'s cnt_selected; matrix: every option\'s count == the results total the selection returns (2026-09-02)' },

...
// query.deal threading (owner request 2026-07-20): every Top-6 call site now passes the query's
// deal alongside k — Deal is chosen before City in the form, so it's always known here. Extended
...
// verify-count-scope-parity.ts for the full contract). Extended 2026-08-20 (Buy+Rent combined
// multi-select, PR#817/owner feature): every call site now reads `effDeal` (= null when

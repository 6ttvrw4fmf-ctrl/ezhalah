...
const AR: Record<string, string> = {
  ...
  // Owner 2026-09-20: dropped the em dash after «هي الأخيرة» (and its counterpart after «عرض
  // المزيد» in the two التحديد-أكثر messages below) — a plain Arabic comma joins the clauses
  // just as clearly and reads more naturally out loud.
  'We still have more for you. Showing {shown} of {total}. This is the last «عرض المزيد» — up to {rest} at once. Want me to show more, or help you find more precise ones?':
    'لسا عندنا لك المزيد! عرضنا لك {shown} من أصل {total} إعلان. «عرض المزيد» الجاية هي الأخيرة، بنعرض لك حتى {rest} إعلان دفعة وحدة. أو نحدد طلبك ونوصّلك للي يناسبك بالضبط.',
  'We still have more for you. Showing {shown} of {total}. This is the last «عرض المزيد» — up to {rest} at once. Want me to show more?':
    'لسا عندنا لك المزيد! عرضنا لك {shown} من أصل {total} إعلان. «عرض المزيد» الجاية هي الأخيرة، بنعرض لك حتى {rest} إعلان دفعة وحدة.',
  ...
  'These are the last {shown} I can show you. Want help finding more precise ones? Or open the menu for a new search.':
    'وصلت لآخر «عرض المزيد»، هذي آخر {shown} إعلان أقدر أعرضها لك. نحدد طلبك؟ اضغط «تحديد أكثر». أو لو تبي بحث جديد، افتح القائمة ☰ فوق واختر «بحث».',
  'These are the last {shown} I can show you. For a new search, open the menu and choose Search.':
    'وصلت لآخر «عرض المزيد»، هذي آخر {shown} إعلان أقدر أعرضها لك. تبي بحث جديد؟ افتح القائمة ☰ فوق واختر «بحث».',
  ...
  'Your choices: {summary}': 'اخترت: {summary}',
  'Skipped: {summary}': 'تخطيت: {summary}',
  ...
  'Bahadhabab Real Estate':            'باحة الضباب العقارية',    // official (bahadhabab-res.com)
  'Alobid Office Real Estate':         'مكتب العبيد العقاري',     // official (alobidoffice.com)
  ...
  'Aqar Al Saudia Real Estate':        'منصة العروض العقارية',     // official (aqaralsaudia.com header)
  'Suwar Real Estate':                 'سوار العقارية',            // official (suwar.sa page title)
  'Rakez Real Estate':                 'راكز العقارية',            // official (rakez.sa page title)

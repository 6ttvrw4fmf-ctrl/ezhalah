...
// COHORT TYPES (owner, 2026-08-15): Trending reacts to the selected property type(s). `types` is the
// EXACT Arabic array the search RPC receives (remote.ts cohortTypesAr — one shared definition), so

...
--
-- ⚠️ READ THIS BEFORE COPYING THIS MIGRATION. The restore below is INCOMPLETE and was repaired by
-- migrations 20260914114725 / 114903 / 115033. It restores listing_location_canonical and its _mv,
-- which is what a ONE-LEVEL dependency query reports as depending on listing_location_index. The
-- CASCADE actually took ELEVEN objects, because listing_native_location_v1 LEFT JOINs
-- listing_location_canonical and a further chain hangs off v1. Use the recipe in
-- 20260913221143_aqaralsaudia_wiring_into_search.sql instead: it captures every dependent with
-- pg_get_viewdef at the top of the migration and replays them verbatim afterwards. Do not plan a
-- CASCADE from a single hop of pg_depend.
--

-- Normal Filter barrier hardening (2026-08-09). The bedrooms field's INGESTION barrier is complete
...
-- for price/area; this is the bedroom analogue that was missing.)

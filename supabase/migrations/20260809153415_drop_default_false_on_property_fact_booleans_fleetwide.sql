...
-- stops the next INSERT from inventing a value. Unwritten fields will now correctly arrive as NULL
...
-- rega_location_verified — those are pipeline/operational state where `false` is a genuine initial
-- value, not a claim about the property.

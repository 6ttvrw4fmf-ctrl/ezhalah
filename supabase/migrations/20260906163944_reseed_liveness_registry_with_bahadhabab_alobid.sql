-- Re-seed the WHOLE liveness registry from sql/mirrors/liveness_registry.json (43 platforms),
-- now including bahadhabab and alobid. Full re-seed + retention delete, per
-- verify-liveness-registry-mirror.ts's required shape.
--
-- Both are Nuzul SaaS tenants (third and fourth found, alongside aldarim and abwbna) — registered
-- CRAWL_PRESENCE_ONLY/168h/grace 3, the same tier aldarim/abwbna already carry.

...
-- needed) to also watch the 3 "broad الأحساء city" resolutions from
-- 20260913182357_amlakalahsa_final_three_districts_get_broad_city.sql — same regression shape
-- (city_ar reverting to NULL on a re-scrape), same check, just three more names in the same list.

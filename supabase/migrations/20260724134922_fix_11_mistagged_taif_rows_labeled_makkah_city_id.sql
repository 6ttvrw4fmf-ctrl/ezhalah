...
--
-- Verified live after applying: Makkah+aqarcity search dropped 53->47 rows (the 6 aqarcity-platform
-- leaked rows excluded), and a Taif+aqarcity search now correctly includes those exact 6 listing_ids.

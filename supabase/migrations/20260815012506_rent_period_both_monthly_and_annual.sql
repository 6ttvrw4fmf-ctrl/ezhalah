...
--
-- Live proof at apply time (2026-08-14): monthly 31,859 + annual 43,287 = 75,146 = the كلاهما union
-- EXACTLY (no double-count), against 75,656 for NULL — the 510-row difference is precisely the
-- unpublished-period rows, correctly excluded.
do $mig$
declare

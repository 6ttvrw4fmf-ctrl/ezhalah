-- Reseed the liveness registry including aqaralsaudia (العروض العقارية, owner-approved
-- 2026-09-13). Generated from sql/mirrors/liveness_registry.json so the Python registry, the JSON
-- mirror and this seed cannot drift — verify-liveness-registry-mirror.ts asserts all three match.
